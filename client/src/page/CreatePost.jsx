...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    ...
    if (form.prompt) {
      ...
      alert("Please enter the prompt for generating Image");
    }
  };
  ...
  const handleSubmit = async(e) => {
    ...
    if(form.prompt && form.photo){
      ...
      alert('Please enter a prompt to generate photo')
    }
  };
        ...
        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
          ...
          <div className="mt-5 flex gap-5 ">
            <button
              ...
              w-full sm:w-auto px-5 py-2.5 text-sm text-center"
            >
